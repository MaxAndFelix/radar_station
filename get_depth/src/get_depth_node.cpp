...
void GetDepth::far_yoloCallback(const my_msgss::msg::Yolopoints &input) {
    ...
    far_depth_qimage_pub->publish(*(cv_bridge::CvImage(std_msgs::msg::Header(), "32FC1", far_depth_show).toCompressedImageMsg()));
...
//            }
    ...
    close_depth_qimage_pub->publish(*(cv_bridge::CvImage(std_msgs::msg::Header(), "32FC1", close_depth_show).toCompressedImageMsg()));
    //waitKey(0);
};
/**
 * 将受到的点云消息转换成点云
...
void GetDepth::get_robots(const my_msgss::msg::Yolopoints &input)
{
...
void GetDepth::allrobots_adjust()
{
